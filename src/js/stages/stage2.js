class SnakeGame {
    constructor() {
        ...
        this.frameInterval = Number(localStorage.getItem('snakeSpeed')) || 400; // Adjust this value for the desired snake speed
    ...
    clearBoard() {
        ...
        backgroundImage.src = '../assets/images/photo-1628260412297-a3377e45006f.jpg';   // Draw the background image on the canvas
