...
function hasVisualEffects() {
    return game.particles.length > 0 || Boolean(game.touchCue && game.touchCue.life > 0);
}

function requestEffectFrame() {
    if (animationFrameId !== null || document.hidden || !hasVisualEffects()) {
        return;
    }
